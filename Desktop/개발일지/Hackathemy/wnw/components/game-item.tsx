    ...
    <div className="" key={game.gameId}>
      <Card className="my-4 h-full w-96 max-w-sm cursor-pointer hover:shadow-lg">
        ...
        <CardContent className="grid gap-4">
          <h1 className="text-lg font-bold">ESG Project Voting Round!</h1>
          <div className="flex items-center space-x-4 rounded-md border p-4">
            <div className="flex-1 space-y-2">
              <div className="h-20 items-center justify-end text-xs text-zinc-400">
                Participate in funding impactful Environmental, Social, and
                Governance initiatives. Cast your vote to decide which project
                receives collective support.
              </div>
            </div>
          </div>
        </CardContent>
